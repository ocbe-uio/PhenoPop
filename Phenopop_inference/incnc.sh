#!/bin/bash
#SBATCH --job-name="nc3bc3"
#SBATCH --output=/cluster/projects/nn9705k/evenmm/difference_data/outfiles/out-inc-nc-gen4-3-%a.out
...
matlab -batch "incnc($SLURM_ARRAY_TASK_ID, true)"
