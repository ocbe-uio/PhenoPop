#!/bin/bash
#SBATCH --job-name="r3bc3"
#SBATCH --output=/cluster/projects/nn9705k/evenmm/difference_data/outfiles/out-inc-r-gen4-3-%a.out
...
matlab -batch "incr($SLURM_ARRAY_TASK_ID, true)"
