function [] = articleplot2(N_true_populations, MixParams, Params, Noise, num_optim, caseno, RUNNING_ON_CLUSTER)
...
if RUNNING_ON_CLUSTER
    save_location = '/cluster/projects/nn9705k/evenmm/article/'
else 
    save_location = './article/'
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if PLOT_DATA
    ...
    saveas(gcf, [save_location, num2str(N_true_populations), '/case', num2str(caseno), '/logl-data-Noise-', num2str(Noise), '.png'])
...
for ii = 1:max_no_populations
    ...
    if PLOT_FINAL_FIT && no_populations <= N_true_populations
        plot_N_c = 200;
        x = zeros(1,plot_N_c);
        ...
        saveas(gcf, [save_location, num2str(N_true_populations), '/case', num2str(caseno), '/logl-inferred_populations-no-pop-', num2str(no_populations), num2str(savestr), '.png'])
...
% Save data
save([strcat(save_location, num2str(N_true_populations), '/case', num2str(caseno), '/negative_loglikelihood_values', savestr, '.mat')], 'negative_loglikelihood_values', 'x_finals_temp', 'true_mixtures', 'inferred_mixtures', 'true_gr50values', 'inferred_GR50s')
...
saveas(gcf, [save_location, num2str(N_true_populations), '/case', num2str(caseno), '/negative_loglikelihood_values', num2str(savestr), '.png'])
