...
def make_pie_plot(N_cases, N_inferred_populations, true_mixtures, estimated_mixtures, estimated_gr50s, true_gr50_for_plotting, mixturecolors, gr50colors_inferred, vlinerange, title, savename, Conc, KNOW_TRUTH=True, concticks=[], pctdistance=1.5, textprops=None, figsize=[], xlabel="None", truegr50regionlimits=[], estimatedgr50regionlimits=[], bbox_to_anchor=(1.03, 0, 0.57, 1), ax_set_position=[0.6,0.1,0.35,0.9], logaxis=True, titlepadding=0.0, wspace=0.2, hspace=0.0, labels_patients = [], mixturecolors_light=[], arrow_multiplier=3, ylim=[], gr50colors_true=[], true_gr50_indices=[], legendcolors=[], legendcolors_inferred=[], limitationflag=0, skewflag=0, dagimflag=0, shannonflag=0, width_ratios=[1,1,7]):
    ...
    if KNOW_TRUTH:
        ...
        for ii in range(N_cases):
            ...
            elif dagimflag and ii == 3:
                gr50colors_pie_true = [desaturate(color, 0.5) for color in mixturecolors]
                axes[ii,0].pie(true_mixtures[ii], colors=gr50colors_pie_true, autopct='%1.0f%%', pctdistance=pctdistance, startangle=28, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif dagimflag and ii == 4:
                gr50colors_pie_true = [desaturate(color, 0.5) for color in mixturecolors]
                axes[ii,0].pie(true_mixtures[ii], colors=gr50colors_pie_true, autopct='%1.0f%%', pctdistance=pctdistance, startangle=60, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif shannonflag and ii == 2:
                gr50colors_pie_true = [desaturate(color, 0.5) for color in mixturecolors]
                axes[ii,0].pie(true_mixtures[ii], colors=gr50colors_pie_true, autopct='%1.0f%%', pctdistance=pctdistance, startangle=6, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif shannonflag and ii == 3:
                gr50colors_pie_true = [desaturate(color, 0.5) for color in mixturecolors]
                axes[ii,0].pie(true_mixtures[ii], colors=gr50colors_pie_true, autopct='%1.0f%%', pctdistance=pctdistance, startangle=60, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif skewflag and ii == 3:
                gr50colors_pie_true = [desaturate(color, 0.5) for color in mixturecolors]
                axes[ii,0].pie(true_mixtures[ii], colors=gr50colors_pie_true, autopct='%1.0f%%', pctdistance=pctdistance, startangle=60, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif skewflag and ii == 4:
                gr50colors_pie_true = [desaturate(color, 0.5) for color in mixturecolors]
            ...
            # Plot inferred pies 
            if limitationflag and ii == 0:
                axes[ii,1].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=54, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif limitationflag and ii == 1:
                ...
                axes[ii,1].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=22, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif dagimflag and ii == 3:
                axes[ii,1].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=28, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif dagimflag and ii == 4:
                ...
                axes[ii,1].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=56, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif skewflag and ii == 3:
                axes[ii,1].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=60, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif skewflag and ii == 4:
                axes[ii,1].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=22, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif skewflag and ii == 7:
                axes[ii,1].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=109-40, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif skewflag and ii == 8:
                axes[ii,1].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=74-35, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            else:
