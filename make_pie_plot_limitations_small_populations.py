    ...
    if KNOW_TRUTH:
        ...
        for ii in range(N_cases):
            ...
            if ii == 0:
                ...
                axes[ii,0].pie(true_mixtures[ii], colors=gr50colors_pie_true, autopct='%1.0f%%', pctdistance=pctdistance, startangle=-10, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif ii == 1:
                gr50colors_pie_true = [desaturate(color, 0.5) for color in mixturecolors]
                axes[ii,0].pie(true_mixtures[ii], colors=gr50colors_pie_true, autopct='%1.0f%%', pctdistance=pctdistance, startangle=-20, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif ii == 2:
                gr50colors_pie_true = [desaturate(color, 0.5) for color in mixturecolors]
                axes[ii,0].pie(true_mixtures[ii], colors=gr50colors_pie_true, autopct='%1.0f%%', pctdistance=pctdistance, startangle=-25, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif ii == 3:
                gr50colors_pie_true = [desaturate(color, 0.5) for color in mixturecolors]
                axes[ii,0].pie(true_mixtures[ii], colors=gr50colors_pie_true, autopct='%1.0f%%', pctdistance=pctdistance, startangle=-30, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif ii == 4:
                gr50colors_pie_true = [desaturate(color, 0.5) for color in mixturecolors]
                axes[ii,0].pie(true_mixtures[ii], colors=gr50colors_pie_true, autopct='%1.0f%%', pctdistance=pctdistance, startangle=40, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif ii == 5:
                gr50colors_pie_true = [desaturate(color, 0.5) for color in mixturecolors]
                axes[ii,0].pie(true_mixtures[ii], colors=gr50colors_pie_true, autopct='%1.0f%%', pctdistance=pctdistance, startangle=40, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif ii == 6:
                ...
                gr50colors_pie_true = [desaturate(color, 0.5) for color in mixturecolors]
                axes[ii,0].pie(true_mixtures[ii], colors=gr50colors_pie_true, autopct='%1.0f%%', pctdistance=pctdistance, startangle=0, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif ii == 8:
                gr50colors_pie_true = [desaturate(color, 0.5) for color in mixturecolors]
                axes[ii,0].pie(true_mixtures[ii], colors=gr50colors_pie_true, autopct='%1.0f%%', pctdistance=pctdistance, startangle=-10, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            else:
                gr50colors_pie_true = [desaturate(color, 0.5) for color in gr50colors_true[ii]]
                axes[ii,0].pie(true_mixtures[ii], colors=gr50colors_pie_true, autopct='%1.0f%%', pctdistance=pctdistance, startangle=-32, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            # Plot inferred pies 
            if ii == 0:
                ...
                axes[ii,1].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=-20, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif ii == 2:
                axes[ii,1].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=-25, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif ii == 3:
                axes[ii,1].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=-30, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif ii == 4:
                axes[ii,1].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=40, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif ii == 5:
                axes[ii,1].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=40, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif ii == 6:
                axes[ii,1].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=40, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif ii == 7:
                axes[ii,1].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=0, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            elif ii == 8:
                axes[ii,1].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=-12, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
            else:
                axes[ii,1].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=-32, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
        ...
        for ii in range(N_cases):
            # Plot inferred pies 
            axes[ii,0].pie(estimated_mixtures[ii], colors=gr50colors_inferred[ii], autopct='%1.0f%%', pctdistance=pctdistance, startangle=-32, wedgeprops = {'linewidth': 1, 'edgecolor' : 'k'}, textprops=textprops)
