...
The PhenoPop method is available in the "Phenopop_inference" folder through the function "PhenoPop(experiment_name, NR, Concentration_array, Time_array, datafile)". 
