function [tMM1420,x_solMM1420,tMM195,x_solMM195,tMM36,x_solMM36]=simulations_mixtures_meflufen(dose_meflu)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  Function to simulate Meflufen therapy in one MM patient (MM1420),
%   DECIPHER estimated 2 different clones and for other two patients 
%   (MM195, MM36) DECIPHER estimated a single clone. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
results_MM1420_meflu=load('negative_loglikelihood_values-MM1420-drug-2.mat');
num_clones=2; %obtained through the elbow method
param_MM1420_meflu=results_MM1420_meflu.x_finals_temp(:,num_clones,:);

%parameters clone1 obtained by DECIPHER
alpha1=param_MM1420_meflu(1);
b1=param_MM1420_meflu(2);
E1=param_MM1420_meflu(3);
n1=param_MM1420_meflu(4);
r1_hours=growth_rate(alpha1,b1,E1,n1,dose_meflu); % units 1/hour
r1=24*r1_hours; % units 1/day
p1=1.e-13;

%parameters clone2 obtained by DECIPHER
alpha2=param_MM1420_meflu(6);
b2=param_MM1420_meflu(7);
E2=param_MM1420_meflu(8);
n2=param_MM1420_meflu(9);
r2_hours=growth_rate(alpha2,b2,E2,n2,dose_meflu); %units 1/hours
...
%initial conditions
prop_clone1=param_MM1420_meflu(5);
...
% Loading results from DECIPHER
results_MM195_seli=load('negative_loglikelihood_values-MM19520-drug-2.mat');
...
% Loading results from DECIPHER
results_MM36_seli=load('negative_loglikelihood_values-MM3620-drug-2.mat');
num_clones=1; %obtained through the elbow method
...
r1_hours=growth_rate(alpha1,b1,E1,n1,dose_meflu); %unit  1/hour
r1=24*r1_hours; %units 1/day
p1= 1.e-13;
